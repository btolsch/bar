=head1 XBM+XFT fork of lemonbar

Thanks to L<LemonBoy|https://github.com/LemonBoy> for the original L<lemonbar|https://github.com/LemonBoy/bar>, L<krypt-n|https://github.com/krypt-n> for the L<xft patch||https://github.com/krypt-n/bar>, and L<mad-s|https://github.com/mad-s> for the original L<xbm patch|https://github.com/LemonBoy/bar/pull/178>.
